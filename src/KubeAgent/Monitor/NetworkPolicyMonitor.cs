...
public class NetworkPolicyMonitor(ILogger<NetworkPolicyMonitor> logger, IKubernetes client, [FromKeyedServices("Dataflow")] IResourceProcessor processor) : BaseMonitor(logger, processor), IResourceMonitor
{
