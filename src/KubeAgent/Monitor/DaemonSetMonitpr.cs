...
public class DaemonSetMonitpr(ILogger<DaemonSetMonitpr> logger, IKubernetes client, ProcessorFactory factory) : BaseMonitor(logger, factory.GetResourceProcessor()), IResourceMonitor
{
